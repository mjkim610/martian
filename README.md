...
Martian Proxy can be installed using `go install`
    ...
    go get github.com/mjkim610/martian/ && \
    go install github.com/mjkim610/martian/cmd/proxy
...
modifier](https://github.com/mjkim610/martian/wiki/Modifier-Reference#logging) is
...
* `[package.Type]`: The package.Type of the modifier that you want to use. In
  ...
  refer to the [modifier reference](https://github.com/mjkim610/martian/wiki/Modifier-Reference)).
...
[`martian.go`](https://github.com/mjkim610/martian/blob/master/martian.go)).
